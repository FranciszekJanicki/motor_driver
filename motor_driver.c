...
static motor_driver_err_t
motor_driver_motor_initialize(motor_driver_t const *driver) {
...
static motor_driver_err_t
motor_driver_motor_deinitialize(motor_driver_t const *driver) {
...
static motor_driver_err_t
motor_driver_motor_set_speed(motor_driver_t const *driver, float32_t speed) {
...
static motor_driver_err_t
motor_driver_encoder_initialize(motor_driver_t const *driver) {
...
static motor_driver_err_t
motor_driver_encoder_deinitialize(motor_driver_t const *driver) {
...
static motor_driver_err_t
motor_driver_encoder_get_position(motor_driver_t const *driver,
                                  float32_t *position) {
  return driver->interface.encoder_get_position
             ? driver->interface.encoder_get_position(
                   driver->interface.encoder_user, position)
             : MOTOR_DRIVER_ERR_NULL;
}

static motor_driver_err_t
motor_driver_regulator_initialize(motor_driver_t const *driver) {
...
static motor_driver_err_t
motor_driver_regulator_deinitialize(motor_driver_t const *driver) {
...
static motor_driver_err_t
motor_driver_regulator_get_control(motor_driver_t const *driver,
                                   float32_t error, float32_t *control,
                                   float32_t delta_time) {
  return driver->interface.regulator_get_control
             ? driver->interface.regulator_get_control(
                   driver->interface.regulator_user, error, control, delta_time)
             : MOTOR_DRIVER_ERR_NULL;
}

static motor_driver_err_t
motor_driver_fault_initialize(motor_driver_t const *driver) {
...
static motor_driver_err_t
motor_driver_fault_deinitialize(motor_driver_t const *driver) {
...
static motor_driver_err_t
motor_driver_fault_get_current(motor_driver_t const *driver,
                               float32_t *current) {
  return driver->interface.fault_get_current
             ? driver->interface.fault_get_current(driver->interface.fault_user,
                                                   current)
             : MOTOR_DRIVER_ERR_NULL;
}

static inline float32_t
motor_driver_clamp_position(motor_driver_t const *driver, float32_t position) {
...
motor_driver_err_t
motor_driver_initialize(motor_driver_t *driver,
...
motor_driver_err_t motor_driver_set_position(motor_driver_t *driver,
  ...
  err = motor_driver_regulator_get_control(driver, error_position,
                                           &control_speed, delta_time);
  if (err != MOTOR_DRIVER_ERR_OK) {
    return err;
  }
  ...
  printf("current: %f, position: %f, measured_position: %f, error_position: "
         "%f, control_speed: "
         "%f\n\r ",
         (double)current, (double)position, (double)measured_position,
         (double)error_position, (double)control_speed);
